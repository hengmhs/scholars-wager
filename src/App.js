...
class App extends React.Component {
    ...
    this.state = {
      HSKLevel1: [
        ...
        },
        {
          ...
          hanzi: "杯子",
          pinyin: "bēi zi",
          translations: ["cup", "glass", "CL:個|个", "支", "枝[zhī]"],
        },
        {
          id: 5,
          hanzi: "北京",
        ...
        },
        {
          ...
          hanzi: "不",
          pinyin: "bù",
          translations: ["(negative prefix)", "not", "no"],
        },
        {
          id: 9,
          hanzi: "菜",
        ...
        },
        {
          ...
          hanzi: "茶",
          pinyin: "chá",
          translations: ["tea", "tea plant", "CL:杯", "壺|壶[hú]"],
        },
        {
          id: 11,
          hanzi: "吃",
        ...
        },
        {
          ...
          hanzi: "出租车",
          pinyin: "chū zū chē",
          translations: ["taxi", "(Taiwan) rental car"],
        },
        {
          id: 13,
          hanzi: "打电话",
        ...
        },
        {
          ...
          hanzi: "电脑",
          pinyin: "diàn nǎo",
          translations: ["computer", "CL:臺|台[tái]"],
        },
        {
          id: 18,
          hanzi: "电视",
          pinyin: "diàn shì",
          translations: ["television", "TV", "CL:臺|台", "個|个[gè]"],
        },
        {
          id: 19,
          hanzi: "电影",
          pinyin: "diàn yǐng",
          translations: ["movie", "film", "CL:部", "片", "幕", "場|场[chǎng]"],
        },
        {
          id: 20,
          hanzi: "东西",
          pinyin: "dōng xi",
          translations: ["thing", "stuff", "person", "CL:個|个", "件[jiàn]"],
        },
        {
          id: 21,
          hanzi: "都",
        ...
        },
        {
          ...
          hanzi: "二",
          pinyin: "èr",
          translations: ["two", "2", "stupid (Beijing dialect)"],
        },
        {
          id: 28,
          hanzi: "饭馆",
        ...
        },
        {
          ...
          hanzi: "个",
          pinyin: "gè",
          translations: ["variant of 個|个[gè]"],
        },
        {
          id: 33,
          hanzi: "工作",
        ...
        },
        {
          ...
          hanzi: "狗",
          pinyin: "gǒu",
          translations: ["dog", "CL:隻|只", "條|条[tiáo]"],
        },
        {
          id: 35,
          hanzi: "汉语",
          pinyin: "Hàn yǔ",
          translations: ["Chinese language", "CL:門|门[mén]"],
        },
        {
          id: 36,
          hanzi: "好",
        ...
        },
        {
          ...
          hanzi: "喝",
          pinyin: "hē",
          translations: ["to drink", "My goodness!"],
        },
        {
          id: 38,
          hanzi: "和",
        ...
        },
        {
          ...
          hanzi: "很",
          pinyin: "hěn",
          translations: ["(adverb of degree)", "quite", "very", "awfully"],
        },
        {
          id: 40,
          hanzi: "后面",
          pinyin: "hòu mian",
          translations: ["rear", "back", "behind", "later", "afterwards"],
        },
        {
          id: 41,
          hanzi: "回",
          pinyin: "huí",
          translations: ["to curve", "to return", "to revolve"],
        },
        {
          id: 42,
          hanzi: "会",
        ...
        },
        {
          ...
          hanzi: "几",
          pinyin: "jǐ",
          translations: ["how much", "how many", "several", "a few"],
        },
        {
          id: 45,
          hanzi: "家",
        ...
        },
        {
          ...
          hanzi: "看见",
          pinyin: "kàn jiàn",
          translations: ["to see", "to catch sight of"],
        },
        {
          id: 52,
          hanzi: "块",
        ...
        },
        {
          ...
          hanzi: "老师",
          pinyin: "lǎo shī",
          translations: ["teacher", "CL:個|个", "位[wèi]"],
        },
        {
          id: 55,
          hanzi: "了",
        ...
        },
        {
          ...
          hanzi: "妈妈",
          pinyin: "mā ma",
          translations: ["mama", "mommy", "mother", "CL:個|个", "位[wèi]"],
        },
        {
          id: 61,
          hanzi: "吗",
        ...
        },
        {
          ...
          hanzi: "猫",
          pinyin: "māo",
          translations: ["cat", "CL:隻|只[zhī]"],
        },
        {
          id: 64,
          hanzi: "没",
          pinyin: "méi",
          translations: ["(negative prefix for verbs)", "have not", "not"],
        },
        {
          id: 65,
          hanzi: "没关系",
        ...
        },
        {
          ...
          hanzi: "名字",
          pinyin: "míng zi",
          translations: ["name (of a person or thing)", "CL:個|个[gè]"],
        },
        {
          id: 69,
          hanzi: "哪",
        ...
        },
        {
          ...
          hanzi: "你",
          pinyin: "nǐ",
          translations: ["you (informal, as opposed to courteous 您)"],
        },
        {
          id: 74,
          hanzi: "年",
          pinyin: "nián",
          translations: ["year", "CL:個|个[gè]"],
        },
        {
          id: 75,
          hanzi: "女儿",
        ...
        },
        {
          ...
          hanzi: "朋友",
          pinyin: "péng you",
          translations: ["friend", "CL:個|个", "位[wèi]"],
        },
        {
          id: 77,
          hanzi: "漂亮",
        ...
        },
        {
          ...
          hanzi: "苹果",
          pinyin: "píng guǒ",
          translations: ["apple", "CL:個|个", "顆|颗[kē]"],
        },
        {
          id: 79,
          hanzi: "七",
        ...
        },
        {
          ...
          hanzi: "前面",
          pinyin: "qián miàn",
          translations: ["ahead", "in front", "preceding", "above"],
        },
        {
          id: 82,
          hanzi: "请",
        ...
        },
        {
          ...
          hanzi: "人",
          pinyin: "rén",
          translations: ["man", "person", "people", "CL:個|个", "位[wèi]"],
        },
        {
          id: 86,
          hanzi: "认识",
        ...
        },
        {
          ...
          hanzi: "商店",
          pinyin: "shāng diàn",
          translations: ["store", "shop", "CL:家", "個|个[gè]"],
        },
        {
          id: 90,
          hanzi: "上",
        ...
        },
        {
          ...
          hanzi: "上午",
          pinyin: "shàng wǔ",
          translations: ["morning", "CL:個|个[gè]"],
        },
        {
          id: 92,
          hanzi: "少",
        ...
        },
        {
          ...
          hanzi: "谁",
          pinyin: "shéi",
          translations: ["who", "also pr. [shuí]"],
        },
        {
          id: 94,
          hanzi: "什么",
          pinyin: "shén me",
          translations: ["what?", "who?", "something", "anything"],
        },
        {
          id: 95,
          hanzi: "十",
        ...
        },
        {
          ...
          hanzi: "时候",
          pinyin: "shí hou",
          translations: ["time", "length of time", "moment", "period"],
        },
        {
          id: 97,
          hanzi: "是",
          pinyin: "shì",
          translations: ["is", "are", "am", "yes", "to be"],
        },
        {
          id: 98,
          hanzi: "书",
        ...
        },
        {
          ...
          hanzi: "喂",
          pinyin: "wèi",
          translations: ["to feed"],
        },
        {
          id: 112,
          hanzi: "我",
          pinyin: "wǒ",
          translations: ["I", "me", "my"],
        },
        {
          id: 113,
          hanzi: "我们",
          pinyin: "wǒ men",
          translations: ["we", "us", "ourselves", "our"],
        },
        {
          id: 114,
          hanzi: "五",
        ...
        },
        {
          ...
          hanzi: "下午",
          pinyin: "xià wǔ",
          translations: ["afternoon", "CL:個|个[gè]", "p.m."],
        },
        {
          id: 118,
          hanzi: "下雨",
        ...
        },
        {
          ...
          hanzi: "小",
          pinyin: "xiǎo",
          translations: ["small", "tiny", "few", "young"],
        },
        {
          id: 123,
          hanzi: "小姐",
        ...
        },
        {
          ...
          hanzi: "星期",
          pinyin: "xīng qī",
          translations: ["week", "CL:個|个[gè]", "day of the week", "Sunday"],
        },
        {
          id: 128,
          hanzi: "学生",
        ...
        },
        {
          ...
          hanzi: "衣服",
          pinyin: "yī fu",
          translations: ["clothes", "CL:件", "套[tào]"],
        },
        {
          id: 133,
          hanzi: "医生",
          pinyin: "yī shēng",
          translations: ["doctor", "CL:個|个", "位", "名[míng]"],
        },
        {
          id: 134,
          hanzi: "医院",
          pinyin: "yī yuàn",
          translations: ["hospital", "CL:所", "家", "座[zuò]"],
        },
        {
          id: 135,
          hanzi: "椅子",
          pinyin: "yǐ zi",
          translations: ["chair", "CL:把", "套[tào]"],
        },
        {
          id: 136,
          hanzi: "有",
        ...
        },
        {
          ...
          hanzi: "月",
          pinyin: "yuè",
          translations: ["moon", "month", "CL:個|个", "輪|轮[lún]"],
        },
        {
          id: 138,
          hanzi: "在",
        ...
        },
        {
          ...
          hanzi: "怎么",
          pinyin: "zěn me",
          translations: ["variant of 怎麼|怎么[zěn me]"],
        },
        {
          id: 141,
          hanzi: "怎么样",
        ...
        },
        {
          ...
          hanzi: "中国",
          pinyin: "Zhōng guó",
          translations: ["China", "Middle Kingdom"],
        },
        {
          id: 144,
          hanzi: "中午",
          pinyin: "zhōng wǔ",
          translations: ["noon", "midday", "CL:個|个[gè]"],
        },
        {
          id: 145,
          hanzi: "住",
        ...
        },
        {
          ...
          hanzi: "桌子",
          pinyin: "zhuō zi",
          translations: ["table", "desk", "CL:張|张", "套[tào]"],
        },
        {
          id: 147,
          hanzi: "字",
  ...
  getRandomChar = () => {
    const index = Math.floor(Math.random() * this.state.HSKLevel1.length);
